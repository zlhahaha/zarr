...
- Read a bounded Blosc1 subset (LZ4/LZ4HC, Zlib, Zstd; no, byte or bit shuffle) from v2/v3 stores, including multi-block and incompressible frames. Blosc writes remain unsupported.
