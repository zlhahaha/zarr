...
| Blosc1 frames (LZ4/LZ4HC/Zlib/Zstd; no, byte or bit shuffle) | Read-only; BloscLZ and writes unsupported | Read-only with explicit supported configuration; BloscLZ and writes unsupported |
